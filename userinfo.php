...
<div class="container">
  ...
  <form id="fm-userinfo" action="userinfo.php" method="GET" class="bg-white p-5 contact-form" >
    ...
    <label>Address: </label> <div id="address-msg" class="feedback"></div> 
    ...
    <div>
      <input type="submit" value="Save Changes" style="margin-top:20px;" name = "btn-save-changes" class="btn btn-primary py-3 px-5" >
    </div>
  </form>
</div>
</div>
